...
int main(int argc, char const *argv[])
{
    ...
    FILE *fp = fopen("transposeMatKernel.cl", "r");
    if (fp == NULL)
    {
    ...
    cl_mem aMemObj = clCreateBuffer(context, CL_MEM_READ_ONLY, len * sizeof(int), NULL, &ret);
    cl_mem bMemObj = clCreateBuffer(context, CL_MEM_WRITE_ONLY, len * sizeof(int), NULL, &ret);
    ...
    cl_kernel kernel = clCreateKernel(pgm, "transpose", &ret);
    ...
    clEnqueueReadBuffer(cq, bMemObj, CL_TRUE, 0, len * sizeof(int), mat2, 0, NULL, NULL);
