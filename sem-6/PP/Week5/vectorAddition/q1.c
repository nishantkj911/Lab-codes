...
int main(int argc, char const *argv[])
{
    ...
    cl_event event;
    clEnqueueNDRangeKernel(cq, kernel, 1, NULL, &global_work_size, &local_work_size, 0, NULL, &event);
    ret = clFinish(cq);
    ...
    double totalTime = (double)(timeEnd - timeStart);
    ...
    printf("The total program took %0.3f ms to execute\n", (float)(end - start) / 1000000);
    printf("The parallel part of program took %0.3f ms\n", totalTime / 1000000);
    return 0;
}
