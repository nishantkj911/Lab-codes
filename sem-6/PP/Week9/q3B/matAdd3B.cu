...
int main()
{
    ...
    scanf("%i %i", &row1, &col1);
    int totalElements1 = row1 * col1, *dN, *dCol2;
    ...
    cudaMemcpy(dCol2, &col2, sizeof(int), cudaMemcpyHostToDevice);

    matAdd<<<row1, 1>>>(dA, dB, dC, dN, dCol2);
