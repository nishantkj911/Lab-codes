...
namespace W8_Q4
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void Give_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand comm = new SqlCommand("select * from lives, works  where [company-name] = @company and [person-name]=[person_name]", con);
            ...
            {
                Label1.Text = "<br />" + ex.StackTrace.Replace("\n", "<br />");
        ...
        protected void Insert_Click(object sender, EventArgs e)
        {
            string str = ConfigurationManager.ConnectionStrings["conStr"].ConnectionString;
            SqlConnection con = new SqlConnection(str);
            using (SqlCommand comm = new SqlCommand("insert into works ([Person-name], [company-name], salary) values (@p, @c, @s)", con))
            {
